...
class Broj1 extends StatelessWidget {
  const Broj1({Key? key}) : super(key: key);
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          // Gumb za povratak (isti kao u Page124)
          Positioned(
            top: 20,
            left: 20,
            child: CircleAvatar(
          ...
          Positioned(
            ...
            child: CircleAvatar(
              ...
              child: IconButton(
                ...
                iconSize: 60,
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => Broj2()));
                },
              ),
            ),
          ),
            ...
            child: CircleAvatar(
              ...
              child: IconButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Broj2()),
                  );
                },
              ),
            ),
