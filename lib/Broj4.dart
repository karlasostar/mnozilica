...
class Broj4 extends StatelessWidget {
  const Broj4({Key? key}) : super(key: key);
            ...
            child: CircleAvatar(
              ...
              child: IconButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Broj5()),
                  );
                },
              ),
            ),
