...
class Broj9 extends StatelessWidget {
  const Broj9({Key? key}) : super(key: key);
            ...
            child: CircleAvatar(
              ...
              child: IconButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Broj10()),
                  );
                },
              ),
            ),
