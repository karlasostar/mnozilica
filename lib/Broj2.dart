...
class Broj2 extends StatelessWidget {
  const Broj2({Key? key}) : super(key: key);
            ...
            child: CircleAvatar(
              ...
              child: IconButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Broj3()),
                  );
                },
              ),
            ),
