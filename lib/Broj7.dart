...
class Broj7 extends StatelessWidget {
  const Broj7({Key? key}) : super(key: key);
            ...
            child: CircleAvatar(
              ...
              child: IconButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Broj8()),
                  );
                },
              ),
            ),
