...
class Broj8 extends StatelessWidget {
  const Broj8({Key? key}) : super(key: key);
            ...
            child: CircleAvatar(
              ...
              child: IconButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Broj9()),
                  );
                },
              ),
            ),
