...
class Broj5 extends StatelessWidget {
  const Broj5({Key? key}) : super(key: key);
            ...
            child: CircleAvatar(
              ...
              child: IconButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Broj6()),
                  );
                },
              ),
            ),
