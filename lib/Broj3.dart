...
class Broj3 extends StatelessWidget {
  const Broj3({Key? key}) : super(key: key);
            ...
            child: CircleAvatar(
              ...
              child: IconButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Broj4()),
                  );
                },
              ),
            ),
